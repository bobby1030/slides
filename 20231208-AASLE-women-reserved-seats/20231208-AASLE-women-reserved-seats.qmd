...
- Conditional on the district's population size, the assignment of gender quota proportion is arguably random (at least uncorrelated with pre-existing gender attitudes).
